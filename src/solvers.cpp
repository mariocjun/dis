...
#pragma omp parallel for schedule(static)
  ...
  preconditioner = preconditioner.cwiseMax(1e-12)
                       .cwiseInverse(); // Inverte (e evita divisão por zero)
...
Eigen::VectorXd &g_signal, const Eigen::MatrixXd &H_model, double tolerance, int
...
&g_signal, const Eigen::MatrixXd &H_model, double tolerance, int max_iterations,
